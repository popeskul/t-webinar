...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(["local/templates/allergology/src/scripts/1_jquery"], function (a0) {
      return (factory(a0));
    });
    ...
    // like Node.
    module.exports = factory(require("local/templates/allergology/src/scripts/1_jquery"));
  } else {
    factory(root["jQuery"]);
  }
...
;(function(factory) {
    'use strict';
    if (typeof define === 'function' && define.amd) {
        define(['local/templates/allergology/src/scripts/1_jquery'], factory);
    } else if (typeof exports !== 'undefined') {
        module.exports = factory(require('local/templates/allergology/src/scripts/1_jquery'));
    } else {
        factory(jQuery);
